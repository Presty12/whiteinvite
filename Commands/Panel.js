...
module.exports.execute = async (client, message, args) => {
    ...
    if (!secim) return message.channel.send(embed.setDescription('Ses veya chat istatistiklerini sıfırlamak istiyorsan **sıfırla ses/chat** bir ayar yapmak istiyorsan aşağıdaki seçimleri kullanmalısın.'));
};
